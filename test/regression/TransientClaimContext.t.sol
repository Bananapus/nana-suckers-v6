...
contract TransientClaimContextRegression is Test {
    ...
    function setUp() public {
        ...
        sucker = TransientContextSwapHarness(
            payable(LibClone.cloneDeterministic(address(singleton), keccak256(bytes("ctx"))))
        );
        sucker.initialize(1);
    }
