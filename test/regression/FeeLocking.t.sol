...
contract RegressionFeeLockingTest is Test {
    ...
    function test_failedToRemoteFeePayment_isRefundableAndExcludedFromNativeClaims() public {
        ...
        ZeroCostBridgeSuckerHarness sucker = ZeroCostBridgeSuckerHarness(
            payable(address(LibClone.cloneDeterministic(address(singleton), "regression-fee-lock")))
        );
    ...
    function test_failedCcipRefund_isRefundableAndExcludedFromNativeClaims() public {
        ...
        CCIPSuckerHarness sucker = CCIPSuckerHarness(
            payable(address(LibClone.cloneDeterministic(address(singleton), "regression-ccip-lock")))
        );
        sucker.initialize(PROJECT_ID);
