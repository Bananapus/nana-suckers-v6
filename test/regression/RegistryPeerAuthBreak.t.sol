...
contract RegressionRegistryPeerAuthBreakTest is Test, TestBaseWorkflow, IERC721Receiver {
    ...
    function setUp() public override {
        ...
        deployer.setChainSpecificConstants(IOPMessenger(MESSENGER), IOPStandardBridge(address(0x1002)));
    ...
    function test_registryDeployedPeersRejectEachOtherAtBridgeAuthBoundary() external {
        ...
        assertNotEq(address(suckerA), address(suckerB), "registry path should not yield matching peer addresses");
