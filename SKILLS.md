...
- Remember that native/native and different-address token mappings are owner-gated per `(localToken, remoteChainId, remoteToken)` route; same-address non-native mappings and disabled mappings bypass that registry owner gate.
